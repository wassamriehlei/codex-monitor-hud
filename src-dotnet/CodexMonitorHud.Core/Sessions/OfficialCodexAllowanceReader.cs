...
public static class OfficialCodexAllowanceReader
{
    ...
    private static async Task<OfficialCodexAllowance?> TryReadAsync(string executable)
    {
        ...
        try
        {
            ...
            await process.StandardInput.WriteLineAsync("{\"method\":\"initialize\",\"id\":1,\"params\":{\"clientInfo\":{\"name\":\"codex-monitor-hud\",\"version\":\"3.4.1\"},\"capabilities\":{\"optOutNotificationMethods\":[\"account/updated\",\"account/rateLimits/updated\"]}}}").ConfigureAwait(false);
