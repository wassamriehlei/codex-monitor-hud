...
To upgrade, exit the HUD, retain the existing `portable-data` directory, replace the other files with a fully extracted new release, then put `portable-data` back beside the EXE.
